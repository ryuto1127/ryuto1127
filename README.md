...
🚨 **[Sonae](https://github.com/WhiteStoneTak/Sonae)** — A personalized disaster-response AI agent for every citizen — 8,000 of them reasoning in parallel on a single AMD MI300X GPU, each adapting to one person's home, body, and family. **Aiming for a world where every emergency alert isn't a generic warning broadcast to thousands, but a personal plan — for every disaster, and the cascade that follows.** 1 week to build. Built for the AMD Hackathon 2026 (Track 3: Vision & Multimodal AI). [Live demo](https://sonae-visitor-lp.vercel.app/)
